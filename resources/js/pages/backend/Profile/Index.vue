<template>
  <BackendLayout>
    <div class="flex justify-center mt-10 px-4">
      ...
      >
        <h1 class="text-3xl font-bold mb-6 text-primary text-center">Admin Profile</h1>

        <!-- Success / Error Messages -->
        <div v-if="message" class="mb-4 text-center text-green-600 font-semibold">
          {{ message }}
        </div>
        <div v-if="errorMessage" class="mb-4 text-center text-red-600 font-semibold">
          {{ errorMessage }}
        </div>

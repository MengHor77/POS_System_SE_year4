            ...
            <form @submit.prevent="updateCashier" class="space-y-4">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        class="input-field w-full border border-border rounded-xl py-4 px-5 pr-14 bg-bgMain focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all shadow-sm"
                    />
                    <button
                        type="button"
                        @click="showOld = !showOld"
                        class="absolute right-4 top-1/2 transform translate-y-1/2 flex items-center justify-center text-muted hover:text-primary transition focus:outline-none"
                    >
                        <i
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        return { form, showOld, showNew, showConfirm, updateCashier };
    },
});
</script>

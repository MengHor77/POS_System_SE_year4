<template>
  <BackendLayout>
    <div class="p-6 bg-bgMain min-h-screen">
      ...
      <button @click="goCreate" class="mb-4 bg-primary text-white px-4 py-2 rounded hover:bg-blue-600">
        Add New Product
      </button>
        ...
        <tbody>
          <tr v-for="product in products" :key="product.id">
            ...
            <td class="border px-4 py-2">
              <button @click="goEdit(product.id)" class="bg-yellow-400 text-white px-2 py-1 rounded hover:bg-yellow-500 mr-2">Edit</button>
